...
NSString *const MJTTableViewCellIdentifier = @"Cell";
...
- (void)viewDidLoad
{
    ...
    // 1.注册
    [self.tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:MJTTableViewCellIdentifier];
...
{
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:MJTTableViewCellIdentifier forIndexPath:indexPath];
...
- (void)dealloc
{
    NSLog(@"MJViewController--dealloc---");
    [_header free];
    [_footer free];
}
