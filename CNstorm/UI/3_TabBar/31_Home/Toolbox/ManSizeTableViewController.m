...
#import "ManSizeTableViewController.h"

@interface ManSizeTableViewController ()

@end

@implementation ManSizeTableViewController
...
{
    [super viewDidLoad];
    self.navigationItem.title = @"男士尺码表";
...
- (void)initMyView
{
    ...
    UIImageView *imageView1 = [[UIImageView alloc]initWithFrame:CGRectMake(0.0f, 10.00f, MainScreenWidth, 1757.5f)];
    [imageView1 setImage:[UIImage imageNamed:@"manSize"]];
...
- (void)viewDidLayoutSubviews
{
    ...
    self.scrollView.contentSize = CGSizeMake(320.0f,1777.5f);
}
