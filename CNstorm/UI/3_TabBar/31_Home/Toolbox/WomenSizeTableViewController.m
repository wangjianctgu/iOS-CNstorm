//
//  WomenSizeTableViewController.m
//  CNstorm
//
...
#import "WomenSizeTableViewController.h"

@interface WomenSizeTableViewController ()

@end

@implementation WomenSizeTableViewController
...
{
    [super viewDidLoad];
    self.navigationItem.title = @"女士尺码表";
...
- (void)initMyView
{
    ...
    UIImageView *imageView1 = [[UIImageView alloc]initWithFrame:CGRectMake(10.0f, 10.00f, 300.0f, 2702.0f)];
    [imageView1 setImage:[UIImage imageNamed:@"womenSize"]];
...
- (void)viewDidLayoutSubviews
{
    ...
    self.scrollView.contentSize = CGSizeMake(320.0f,2722.0f);
}
