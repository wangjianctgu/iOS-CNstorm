...
#define ORIGINAL_POINT CGPointMake(13.0f, -20.0f)
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.bgImageView.image = [UIImage imageNamed:@"personBg"];
        ...
        self.containerView.backgroundColor = [UIColor colorWithRed:(240.0f)/255.0f green:(240.0f)/255.0f blue:(240.0f)/255.0f alpha:1];
        
        //刷新标志
        _refreshImgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 15, 15)];
...
-(void)prepare
{
    self.scrollView.contentSize = CGSizeMake(self.scrollView.frame.size.width, self.scrollView.frame.size.height+CellHeight);
}
