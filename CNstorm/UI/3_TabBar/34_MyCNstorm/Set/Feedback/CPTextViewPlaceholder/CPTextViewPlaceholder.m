...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        self.placeholderColor = [UIColor colorWithRed:(200.0f/255.0f) green:(200.0f/255.0f) blue:(200.0f/255.0f) alpha:1.0f];
        self.originalCorrection = self.autocorrectionType;
        self.originalTextColor = [UIColor colorWithRed:(153.0f/255.0f) green:(153.0f/255.0f) blue:(153.0f/255.0f) alpha:1.0f];
