...
@implementation AllWayTableViewCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        self.wayNoLabel = [[UILabel alloc]initWithFrame:CGRectMake(10.0f, 5.0f, 200.0f, 20.0f)];
        self.wayNoLabel.textColor = [UIColor colorWithRed:(153.0f/255.0f) green:(153.0f/255.0f) blue:(153.0f/255.0f) alpha:1.0f];
        self.wayNoLabel.font = [UIFont systemFontOfSize:13.0f];
        self.wayNoLabel.lineBreakMode = NSLineBreakByTruncatingTail;
        self.wayNoLabel.numberOfLines = 1;
        self.wayNoLabel.textAlignment = NSTextAlignmentLeft;
        self.wayNoLabel.adjustsFontSizeToFitWidth = YES;
        self.wayNoLabel.baselineAdjustment = UIBaselineAdjustmentNone;
        [self.contentView addSubview:self.wayNoLabel];
        
        UIView *lineView = [[UIView alloc]initWithFrame:CGRectMake(10.0f, 25.0f, 300.0f, 1.0f)];
        lineView.backgroundColor = [UIColor colorWithRed:(229.0f/255.0f) green:(229.0f/255.0f) blue:(229.0f/255.0f) alpha:1.0f];
        [self.contentView addSubview:lineView];
        
        self.wayTitelLabel = [[UILabel alloc]initWithFrame:CGRectMake(10.0f, 25.0f, 300.0f, 40.0f)];
        ...
        self.isCancelButton = [[UIButton alloc]initWithFrame:CGRectMake(280.0f, 5.0f, 30.0f, 20.0f)];
        ...
        self.wayPackageCountLabel = [[UILabel alloc]initWithFrame:CGRectMake(10.0f, 65.0f, 200.0f, 18.0f)];
        ...
        self.yunfeiLabel = [[UILabel alloc]initWithFrame:CGRectMake(10.0f, 83.0f, 60.0f, 18.0f)];
        ...
        self.yunfeiInfoLabel = [[UILabel alloc]initWithFrame:CGRectMake(50.0f, 83.0f, 150.0f, 18.0f)];
        ...
        self.wayStatusButton = [[UIButton alloc]initWithFrame:CGRectMake(240.0f, 65.0f, 70.0f, 30.0f)];
        ...
        UIView *footerView = [[UIView alloc] initWithFrame:CGRectMake(0.0f, 104.0f, 320.0f, 12.0f)];
...
- (void)layoutSubviews
{
    ...
    self.wayNoLabel.text = [NSString stringWithFormat:@"运单编号:%@",self.way.wayNo];
