//
//  AwaitPayOrderDetailViewController.m
//  CNstorm
//
...
@interface AwaitPayOrderDetailViewController ()

@end

@implementation AwaitPayOrderDetailViewController
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.title = @"待付款订单详情";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    AwaitPayOrderDetailTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:OrderTableViewCellIdentifier];
    
    if (cell==nil)
    {
        cell=[[AwaitPayOrderDetailTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:OrderTableViewCellIdentifier];
    }
