//
//  AwaitReceiveDetailViewController.m
//  CNstorm
//
...
#import "AwaitReceiveDetailViewController.h"

@interface AwaitReceiveDetailViewController ()

@end

@implementation AwaitReceiveDetailViewController
...
- (void)initMyView
{
    ...
    {
        wayStatusButtonTitle = @"确认收货";
    }
    else
    {
        wayStatusButtonTitle = @"已收货";
    }
...
{
    static NSString *AwaitReceiveDetailTableViewCellIdentifier = @"AwaitReceiveDetailTableViewCellIdentifier";
    
    AwaitReceiveDetailTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:AwaitReceiveDetailTableViewCellIdentifier];
    
    if (cell==nil)
    {
        cell = [[AwaitReceiveDetailTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:AwaitReceiveDetailTableViewCellIdentifier];
    }
