//
//  AwaitSendOrderDetailViewController.m
//  CNstorm
//
...
@interface AwaitSendOrderDetailViewController ()

@end

@implementation AwaitSendOrderDetailViewController
...
{
    [super viewDidLoad];
    self.navigationItem.title = @"待发货订单详情";
...
{
    static NSString *AwaitSendOrderDetailTableViewCellIdentifier = @"AwaitSendOrderDetailTableViewCellIdentifier";
    
    AwaitSendOrderDetailTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:AwaitSendOrderDetailTableViewCellIdentifier];
    
    if (cell==nil)
    {
        cell=[[AwaitSendOrderDetailTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:AwaitSendOrderDetailTableViewCellIdentifier];
    }
