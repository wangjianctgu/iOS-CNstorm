...
@interface PayComViewController ()

@end

@implementation PayComViewController
...
- (void)initMyView
{
    ...
    if (self.payType == 0)
    {
        commitLabel.text = @"订单已支付成功！";
    }
    else if (self.payType == 1)
    {
        commitLabel.text = @"运单已支付成功！";
    }
    else
    {
        commitLabel.text = @"充值成功！";
    }
