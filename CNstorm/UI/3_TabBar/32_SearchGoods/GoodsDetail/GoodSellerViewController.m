...
@interface GoodSellerViewController ()

@end

@implementation GoodSellerViewController
...
- (void)viewDidLoad
{
    ...
    if (self.sellerUrl.length > 0)
    {
        NSURL *url = [NSURL URLWithString:self.sellerUrl];//创建URL
