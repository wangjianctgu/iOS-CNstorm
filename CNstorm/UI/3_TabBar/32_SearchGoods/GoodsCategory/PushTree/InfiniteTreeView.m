...
//    _lineView = [[UIImageView alloc] initWithFrame:CGRectMake(85.0f, -200.0f, 15.0f, 300.0f)];
//    [_lineView setImage:[UIImage imageNamed:@"shadow"]];
//    _lineView.hidden = NO;
...
- (void)collectTableViews
{
    ...
    for (UIView *subview in self.subviews) {
        if ([subview isKindOfClass:[InfiniteTreeTableView class]]) {
            ...
            //[treeTableView setBorderColor:[UIColor whiteColor] width:5.0f];
            if (0 == index) {
...
//        if (i == 0)
//        {
//            pushTreeTableView.separatorStyle = UITableViewCellSeparatorStyleNone;
//            [pushTreeTableView reloadData];
//        }
//        else
//        {
//            pushTreeTableView.separatorStyle = UITableViewCellSeparatorStyleSingleLine;
//            pushTreeTableView.separatorInset = UIEdgeInsetsMake(0.0f,15.0f,0.0f,15.0f);
//            pushTreeTableView.separatorColor = [UIColor colorWithRed:(229.0f)/255.0f green:(229.0f)/255.0f blue:(229.0f)/255.0f alpha:(1.0f)];
//            [pushTreeTableView reloadData];
//        }
//        i++;
...
{
    NSString *key = [NSString stringWithFormat:@"LEVEL%d",(int)level];
