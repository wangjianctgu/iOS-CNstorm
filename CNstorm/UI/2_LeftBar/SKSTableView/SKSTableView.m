...
- (void)setSKSTableViewDelegate:(id<SKSTableViewDelegate>)SKSTableViewDelegate
{
    ...
    [self setSeparatorColor:[UIColor purpleColor]];
...
- (void)setSeparatorColor:(UIColor *)separatorColor
{
    ...
    [SKSTableViewCellIndicator setIndicatorColor:[UIColor purpleColor]];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (![self.expandedIndexPaths[indexPath.section] containsObject:indexPath]) {
        ...
        //cell.backgroundColor = [self separatorColor];//设置背景颜色
